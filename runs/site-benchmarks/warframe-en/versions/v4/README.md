...
Reconstrução editável e versionada do estado dinâmico aprovado em `1440×5837`.
O documento medido tem largura `1983`, registrada como overflow acidental; o
frame permanece com `1440` de largura conforme aprovação do usuário. Esta v4 foi
aceita pelo usuário como a versão oficial/canônica do benchmark.
