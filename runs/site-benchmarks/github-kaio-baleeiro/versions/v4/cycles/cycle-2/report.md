...
Aggregate score: **83.92/100**
Minimum screen score: **83.92/100**
Coverage: **93.42%** (required ≥80%)
...
- Score: **83.92**; coverage: **93.42%**; status: **FAIL**
- Viewport: **1440×900**; frame: **1440×1807**; capture: **full_page**
- Similarity evidence: pixel=0.9718, exact=0.8644
...
|---|---:|---:|---:|---|
| Geometry/alignment | 25 | 85.67 | 21.42 | local foreground IoU=0.997, edge IoU=0.288, bbox IoU=1.000 |
| Spacing/grid | 15 | 66.37 | 9.96 | edge IoU=0.288, regional floor=0.797, row/column MAE=0.001/0.002 |
| Typography | 15 | 83.99 | 12.60 | local dark similarity=0.908, edge IoU=0.288; image-only heuristic |
...
| Assets | 15 | 77.51 | 11.63 | local pixel similarity=0.975, edge IoU=0.288; image-only heuristic |
