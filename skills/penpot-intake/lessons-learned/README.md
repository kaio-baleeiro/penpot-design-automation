...
`kind: project` para comportamento do workflow e integre a regra à skill,
referência, script, teste ou gate após verificá-la.

Regra base: nenhuma captura ou construção começa antes das perguntas iniciais,
do adendo/mudança e da análise de ambiguidades.
